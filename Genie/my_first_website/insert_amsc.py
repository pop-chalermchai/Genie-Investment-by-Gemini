...
# 1. Read files
with open("/Users/popular/Desktop/Genie/research/AMSC/01_Valerie_AMSC_Analysis.md", "r", encoding="utf-8") as f:
    en_overview = f.read()

with open("/Users/popular/Desktop/Genie/research/AMSC/02_Christian_AMSC_Audit.md", "r", encoding="utf-8") as f:
    en_dcf = f.read()

with open("/Users/popular/Desktop/Genie/research/AMSC/01_Valerie_AMSC_Analysis_TH.md", "r", encoding="utf-8") as f:
    th_overview = f.read()

with open("/Users/popular/Desktop/Genie/research/AMSC/02_Christian_AMSC_Audit_TH.md", "r", encoding="utf-8") as f:
    th_dcf = f.read()
