...
# 1. Read files
with open("/Users/popular/Desktop/Genie/research/LITE/01_Valerie_LITE_Analysis.md", "r", encoding="utf-8") as f:
    en_overview = f.read()

with open("/Users/popular/Desktop/Genie/research/LITE/02_Christian_LITE_Audit.md", "r", encoding="utf-8") as f:
    en_dcf = f.read()

with open("/Users/popular/Desktop/Genie/research/LITE/01_Valerie_LITE_Analysis_TH.md", "r", encoding="utf-8") as f:
    th_overview = f.read()

with open("/Users/popular/Desktop/Genie/research/LITE/02_Christian_LITE_Audit_TH.md", "r", encoding="utf-8") as f:
    th_dcf = f.read()
