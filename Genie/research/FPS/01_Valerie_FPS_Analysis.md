...
```mermaid
graph TD
    A["AI Data Center Boom & Hyperscaler CapEx Tsunami"] --> B["Record-Setting Backlog: $1.98B (+157% YoY)"]
    C["Severe Grid Bottlenecks & Utility Lead Times (Up to 4 Yrs)"] --> D["Forgent Moat: Shortest Lead Times (6 Months)"]
    B --> E["Rapid Order Conversion: Book-to-Bill 2.3x"]
    D --> E
    E --> F["EBITDA Scaling to $396M (FY27e)"]
    G["CapEx Ramps Down (FY26 $205M to FY27e 1.5% of Rev)"] --> H["FCF Inflection: >$150M Base"]
    F --> I["Target Valuation: $71.00/Share"]
    H --> I
    I --> J["3.0x Asymmetric Payoff Ratio at $47.00 Entry"]
```
